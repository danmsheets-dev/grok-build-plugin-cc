function redactSecrets(text) {
  ...
  result = result.replace(
    // The prefix must be optional. Requiring a leading character meant API_TOKEN=
    // matched but a bare password= / token= / secret= did not — the commonest form.
    /\b([A-Za-z0-9_]*(?:token|secret|key|password)[A-Za-z0-9_]*)(\s*[=:]\s*)(["']?)([A-Za-z0-9._/+\-]{8,})\3/gi,
