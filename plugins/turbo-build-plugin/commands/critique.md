...
- After launching the command, tell the user: "Grok Build critique started in the background. Check `/turbo-build-plugin:runs` for progress. Stop with `/turbo-build-plugin:stop`."
