 ...
 * `.grok/plugins/turbo-build-runtime/` (see xai-grok-agent plugins/discovery.rs:
...
export function writeRuntimeMcpJson(worktreePath, options = {}) {
  ...
  const targetDir = path.join(path.resolve(String(worktreePath)), ".grok", "plugins", "turbo-build-runtime");
